...
<div class="home-slider clearfix">
  ...
  <?php }else{?>
<div class="banner clearfix" style="background-repeat: no-repeat; background-position: center top; background-image: url('http://inspirythemesdemo.com/medicalpress/wp-content/themes/medical-theme/images/banner.jpg'); background-size: cover;"></div><div class=" page-top clearfix">
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 ">
                <nav class="bread-crumb">
                    <ul class="breadcrumb clearfix"><li><a href="http://inspirythemesdemo.com/medicalpress">Medical Press</a><span class="divider"></span></li><li><a href="http://inspirythemesdemo.com/medicalpress/category/health-basics/">Health Basics</a> <span class="divider"></span></li><li><li class="active">Image Post Format</li></ul>                </nav>
            </div>
